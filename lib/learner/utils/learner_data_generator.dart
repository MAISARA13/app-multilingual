...
List<LearnerFeaturedModel> learnerGetFavourites() {
  ...
  featured2.name = "Coming Soon";
  featured2.price = "Unknown";
  ...
  featured5.price = "Unknown";
  featured5.strikePrice = "";
  featured5.type = "None";

  LearnerFeaturedModel featured6 = LearnerFeaturedModel();
  featured6.img = learner_ic_comingsoon;
  featured6.name = "Coming Soon";
  featured6.price = "Unknown";
  featured6.strikePrice = "";
  featured6.type = "None";

  LearnerFeaturedModel featured3 = LearnerFeaturedModel();
  featured3.img = learner_ic_comingsoon;
  featured3.name = "Coming Soon";
  featured3.price = "Unknown";
  featured3.strikePrice = "";
  featured3.type = "None";

  LearnerFeaturedModel featured4 = LearnerFeaturedModel();
  featured4.img = learner_ic_comingsoon;
  featured4.name = "Coming Soon";
  featured4.price = "Unknown";
  featured4.strikePrice = "";
  featured4.type = "None";

  LearnerFeaturedModel featured7 = LearnerFeaturedModel();
  featured7.img = learner_ic_comingsoon;
  featured7.name = "Coming Soon";
...
List<LearnerCoursesModel> learnerGetCourses() {
  ...
  courses.img = learner_ic_alfatihah;
  courses.name = "Alfatihah";

  LearnerCoursesModel courses2 = LearnerCoursesModel();
  courses2.img = learner_walk_1;
  courses2.name = "Introduction";
